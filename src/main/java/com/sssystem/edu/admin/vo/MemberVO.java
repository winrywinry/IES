...
public class MemberVO {
	...
	public MemberVO(int user_no, String user_pwd, String user_nm,
			...
			String address, String email, String profil_picture,
			String admin_yn, String manage_yn, Date hiredate, Date input_dt) {
		super();
	...
	public String toString() {
		return "MemberBean [user_no=" + user_no + "user_pwd=" + user_pwd
				+ ", user_nm=" + user_nm + ", emp_serial=" + emp_serial
				+ ", birth_dt=" + birth_dt + ", gender_yn=" + gender_yn
				+ ", dept_no=" + dept_no + ", dept_nm=" + dept_nm + ", job_no="
				+ job_no + ", job_nm=" + job_nm + ", user_id=" + user_id
				+ ", line_no=" + line_no + ", phone_no=" + phone_no
				+ ", second_no=" + second_no + ", post=" + post + ", address="
				+ address + ", email=" + email + ", profil_picture="
				+ profil_picture + ", admin_yn=" + admin_yn + ", manage_yn="
				+ manage_yn + ", hiredate=" + hiredate + ", input_dt="
				+ input_dt + "]";
	}
}